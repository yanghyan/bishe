          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="/bishe/CLY/index.php/Admin/Users/insert" method="post" onsubmit="return doSubmit()">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="email" class="form-control" name="email" placeholder="Email" onblur="checkEmail()" onfocus="checkEm()">
                      </div>
                    </div>
                    <div class="form-group">
  ...
  <!--图片上传-->
   ...
   <script type="text/javascript">
      ...
      <script type="text/javascript">
          //表单提交限制
          function doSubmit() {
            return checkUserName()&&checkEmail()&&checkPass()&&checkRPass();
          }
          //检测用户名
          function checkUser() {
