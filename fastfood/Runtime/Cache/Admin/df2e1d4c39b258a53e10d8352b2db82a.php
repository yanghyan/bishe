          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="/bishe/CLY/index.php/Admin/Delivery/update" method="post" onsubmit="return doSubmit()">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="input" class="form-control" name="name" placeholder="UserName" value="<?php echo ($u["name"]); ?>"  onfocus="checkFName()" onblur="checkName()">
                      </div>
                    </div>
                     <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">性别</label><span style="font-size:12px;color:#fc0;" id="user"></span>
                      <div class="col-sm-4">
                        <input type="radio" name="sex"  value="1" <?php if(($u["sex"]) == "1"): ?>checked<?php endif; ?>>男
                        <input type="radio" name="sex"  value="0" <?php if(($u["sex"]) == "0"): ?>checked<?php endif; ?>>女
                        <input type="radio" name="sex"  value="" <?php if(($u["sex"]) == ""): ?>checked<?php endif; ?>>未知
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">电话</label><span style="font-size:12px;color:#fc0;" id="phone"></span>
                      <div class="col-sm-4">
                        <input type="input" class="form-control" name="phone" placeholder="Phone" value="<?php echo ($u["phone"]); ?>"  onfocus="checkFPhone()" onblur="checkPhone()">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">邮箱</label><span style="font-size:12px;color:#fc0;" id="email"></span>
                      <div class="col-sm-4">
                        <input type="email" class="form-control" name="email" placeholder="Email" onblur="checkEmail()" onfocus="checkEm()" value="<?php echo ($u["email"]); ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select class="form-control" name="area">
                          ...
                          <option value="1" <?php if(($d["area"]) == "1"): ?>selected<?php endif; ?>>小店区</option>
                          <option value="2" <?php if(($d["area"]) == "2"): ?>selected<?php endif; ?>>迎泽区</option>
                          <option value="3" <?php if(($d["area"]) == "3"): ?>selected<?php endif; ?>>杏花岭区</option>
                          <option value="4" <?php if(($d["area"]) == "4"): ?>selected<?php endif; ?>>尖草坪区</option>
                          <option value="5" <?php if(($d["area"]) == "5"): ?>selected<?php endif; ?>>万柏林区</option>
                          <option value="6" <?php if(($d["area"]) == "6"): ?>selected<?php endif; ?>>晋源区</option>                      
                        </select>
                      </div>
                    </div>
					         <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">性别</label><span style="font-size:12px;color:#fc0;" id="user"></span>
                      <div class="col-sm-4">
                        <input type="radio" name="status"  value="2" <?php if(($d["status"]) == "2"): ?>checked<?php endif; ?>>闲时
                        <input type="radio" name="status"  value="1" <?php if(($d["status"]) == "1"): ?>checked<?php endif; ?>>正在配送
                        <input type="radio" name="status"  value="0" <?php if(($d["status"]) == "0"): ?>checked<?php endif; ?>>禁用
