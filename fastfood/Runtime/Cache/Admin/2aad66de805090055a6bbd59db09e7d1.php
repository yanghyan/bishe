            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-th"></i> 购物车</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
					<div class="form-group">
					<form action="/bishe/CLY/index.php/Admin/Cart/index" method="get" class="form-inline">
						<input class="form-control" id="exampleInputName2" placeholder="用户" type="text" name="username" size="12">&nbsp;&nbsp;
					...
					<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$cart): ?><tr class="<?php echo ($me["id"]); ?>">
						  <td><?php echo ($cart["id"]); ?></td>
						  <td><?php echo ($cart["username"]); ?></td>
						  <td><?php echo ($cart["menu"]); ?></td>
						  <td><?php echo ($cart["shopname"]); ?></td>
						  <td><?php echo ($cart["num"]); ?></td>
						  <td><?php echo (date("Y-m-d",$cart["addtime"])); ?></td>
						  <!--<td>
							<button class="btn btn-xs btn-danger" onclick="off(<?php echo ($me["id"]); ?>)">清空</button><br><br>
						  </td>-->
