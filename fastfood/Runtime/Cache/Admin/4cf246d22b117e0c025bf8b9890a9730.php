            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
					...
					<form action="/bishe/CLY/index.php/Admin/Indent/index" method="get" class="form-inline">
					...
					<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$ind): ?><tr>
						  <td><?php echo ($ind["id"]); ?></td>
						  <td><?php echo ($ind["username"]); ?></td>
						  <td><?php echo ($ind["shopname"]); ?></td>
						  <td><?php echo ($ind["name"]); ?></td>
						  <td><?php echo ($ind["menu"]); ?></td>
						  <td><?php echo ($ind["order_num"]); ?></td>
						  <td><?php echo ($ind["num"]); ?></td>
						  <td><?php echo (date("Y-m-d H:i:s",$ind["start_time"])); ?></td>
						  <td>
							<?php if($ind["state"] == 1): elseif($ind["state"] == 2): ?>
							<?php elseif($ind["state"] == 3): ?>
							<?php else: echo (date("Y-m-d H:i:s",$ind["end_time"])); endif; ?>
						  </td>
						  <td>
							<?php if($ind["state"] == 1): ?>已下单
						    <?php elseif($ind["state"] == 2): ?>已接单
						    <?php elseif($ind["state"] == 3): ?>配送中
						    <?php else: ?> 配送完成<?php endif; ?>
						  </td>
						  <td><?php echo ($ind["remark"]); ?></td>
