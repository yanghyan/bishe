          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="/bishe/CLY/index.php/Admin/Addr/update" method="post" onsubmit="return doSubmit()">
                  <input type="hidden" value="<?php echo ($addr["id"]); ?>" name="id">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">用户名</label><span style="font-size:12px;color:#fc0;" id="user"></span>
                      <div class="col-sm-4">
                        <input type="input" class="form-control" name="username" placeholder="UserName" onblur="checkUserName()" onfocus="checkUser()" value="<?php echo ($addr["username"]); ?>" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">收货人</label><span style="font-size:12px;color:#fc0;" id="name" ></span>
                      <div class="col-sm-4">
                        <input type="input" class="form-control" name="name" placeholder="Name" value="<?php echo ($addr["name"]); ?>"  onfocus="checkFName()" onblur="checkName()">
                      </div>
                    </div>
                     <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">性别</label><span style="font-size:12px;color:#fc0;" id="sex"></span>
                      <div class="col-sm-4">
                        <input type="radio" name="sex"  value="1" <?php if(($addr["sex"]) == "1"): ?>checked<?php endif; ?>>男
                        <input type="radio" name="sex"  value="0" <?php if(($addr["sex"]) == "0"): ?>checked<?php endif; ?>>女
                        <input type="radio" name="sex"  value="" <?php if(($addr["sex"]) == ""): ?>checked<?php endif; ?>>未知
                      </div>
                    </div>
                     <div class="form-group">
                      ...
                      <div class="col-sm-4">                         
                          <select class="form-control" name="address">
                            ...
                            <option value="1" <?php if(($addr["address"]) == "1"): ?>selected<?php endif; ?>>小店区</option>
                            <option value="2" <?php if(($addr["address"]) == "2"): ?>selected<?php endif; ?>>迎泽区</option>
                            <option value="3" <?php if(($addr["address"]) == "3"): ?>selected<?php endif; ?>>杏花岭区</option>
                            <option value="4" <?php if(($addr["address"]) == "4"): ?>selected<?php endif; ?>>尖草坪区</option>
                            <option value="5" <?php if(($addr["address"]) == "5"): ?>selected<?php endif; ?>>万柏林区</option>
                            <option value="6" <?php if(($addr["address"]) == "6"): ?>selected<?php endif; ?>>晋源区</option>                      
                          </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="input" class="form-control" name="detail_add" placeholder="Phone" value="<?php echo ($addr["detail_add"]); ?>" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">手机号</label><span style="font-size:1=2px;color:#fc0;" id="phone"></span>
                      <div class="col-sm-4">
                        <input type="input" class="form-control" name="phone" placeholder="Phone" value="<?php echo ($addr["phone"]); ?>"  onfocus="checkFPhone()" onblur="checkPhone()">
                      </div>
                    </div>
