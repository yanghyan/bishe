            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-plus"></i> 编辑店铺信息</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="/bishe/CLY/index.php/Admin/Shop/update" method="post" onsubmit="return doSubmit()" enctype="multipart/form-data">
                  <input type="hidden" value="<?php echo ($s["id"]); ?>" name="id">
                  <input type="hidden" value="<?php echo ($u["id"]); ?>" name="uid">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">用户名</label><span style="font-size:12px;color:#fc0;" id="user"></span>
                      <div class="col-sm-4">
                        <input type="input" class="form-control" name="username" placeholder="UserName" onblur="checkUserName()" onfocus="checkUser()" value="<?php echo ($u["username"]); ?>" readonly >
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">店铺名</label><span style="font-size:12px;color:#fc0;" id="shopname"></span>
                      <div class="col-sm-4">
                        <input type="input" class="form-control" name="shopname" placeholder="ShopName" value="<?php echo ($s["shopname"]); ?>" onblur="checkShopName()" onfocus="checkShop()">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select class="form-control" name="address">
                          ...
                          <option value="1" <?php if(($s["address"]) == "1"): ?>selected<?php endif; ?>>小店区</option>
                          <option value="2" <?php if(($s["address"]) == "2"): ?>selected<?php endif; ?>>迎泽区</option>
                          <option value="3" <?php if(($s["address"]) == "3"): ?>selected<?php endif; ?>>杏花岭区</option>
                          <option value="4" <?php if(($s["address"]) == "4"): ?>selected<?php endif; ?>>尖草坪区</option>
                          <option value="5" <?php if(($s["address"]) == "5"): ?>selected<?php endif; ?>>万柏林区</option>
                          <option value="6" <?php if(($s["address"]) == "6"): ?>selected<?php endif; ?>>晋源区</option>                   
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="input" class="form-control" name="detail_add" placeholder="DetailAddress" value="<?php echo ($s["detail_add"]); ?>"  onfocus="checkFDtail()" onblur="checkDtail()">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <select class="form-control" name="kind">
                            ...
                            <?php if(is_array($kind)): foreach($kind as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if(($s["kind"]) == $vo["id"]): ?>selected<?php endif; ?>><?php echo ($vo["classname"]); ?></option><?php endforeach; endif; ?>               
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="radio" name="shoptype"  value="1" <?php if(($s["shoptype"]) == "1"): ?>checked<?php endif; ?>>个体商户
                          <input type="radio" name="shoptype"  value="0" <?php if(($s["shoptype"]) == "0"): ?>checked<?php endif; ?>>企业商户
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-2">
                          <div id="previewDoor">
                            <img id="imgheadDoor" border="0" src="/bishe/CLY/Public/Uploads/s_<?php echo ($s["door_pic"]); ?>" width="90" height="90" onclick="$('#previewImgDoor').click();">
                         </div>         
                          <input type="file" onchange="previewImage(this,'Door')" style="display: none;" id="previewImgDoor" name="door_pic">
                        </div>
                        <div class="col-sm-2">
                          <div id="previewEnv">
                            <img id="imgheadEnv" border="0" src="/bishe/CLY/Public/Uploads/s_<?php echo ($s["env_pic"]); ?>" width="90" height="90" onclick="$('#previewImgEnv').click();">
                         </div>         
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="radio" name="info"  value="0" <?php if(($s["info"]) == "0"): ?>checked<?php endif; ?>>营业执照
                          <input type="radio" name="info"  value="1" <?php if(($s["info"]) == "1"): ?>checked<?php endif; ?>>餐饮服务许可证
                          <input type="radio" name="info"  value="2" <?php if(($s["info"]) == "2"): ?>checked<?php endif; ?>>其他资质
                          <input type="radio" name="info"  value="3" <?php if(($s["info"]) == "3"): ?>checked<?php endif; ?>>无资质
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <div id="previewInfo">
                            <img id="imgheadInfo" border="0" src="/bishe/CLY/Public/Uploads/s_<?php echo ($s["info_pic"]); ?>" width="90" height="90" onclick="$('#previewImgInfo').click();">
                         </div>         
