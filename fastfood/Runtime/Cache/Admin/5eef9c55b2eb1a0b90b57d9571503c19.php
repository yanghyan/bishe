...
<html>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
                  <form  class="form-inline" action="/bishe/CLY/index.php/Admin/Delivery/index" method="get">
                  ...
                  <tbody>
                   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><?php if(($vo["area"] == 1) ): ?>小店区<?php elseif(($vo["area"] == 2)): ?>迎泽区<?php elseif(($vo["area"] == 3)): ?>杏花岭区<?php elseif(($vo["area"] == 4)): ?>尖草坪区<?php elseif(($vo["area"] == 5)): ?>万柏林区<?php elseif(($vo["area"] == 4)): ?>晋源区<?php endif; ?> </td>
                      <td><?php if(($vo["status"] === '0') ): ?>禁用<?php elseif(($vo["status"] == 1)): ?>正在配送<?php elseif(($vo["status"] == 2)): ?>闲时<?php endif; ?></td>
                      <td><?php echo (date("Y-m-d",$vo["addtime"])); ?></td>
                      <td ><button class="btn btn-xs btn-danger" id="myalert" onclick="doDel(this,<?php echo ($vo["id"]); ?>)">删除</button> 
                      <button class="btn btn-xs btn-primary" onclick="doEdit(<?php echo ($vo["id"]); ?>)">编辑</button> </td>
  ...
  <script type="text/javascript">
       ...
       function doDel(obj,id){
            Modal.confirm({msg:'确定要删除当前标签吗？'}).on(function(e){
                if (e) {
                    $.ajax({
                      type:"get",
                      url:"/bishe/CLY/index.php/Admin/Delivery/del",
                      data:"id="+id,
                      dataType:"json",
      ...
      function doEdit(id) {
          window.location.href="/bishe/CLY/index.php/Admin/Delivery/edit/id/"+id;
      }
      function doPass(id){
          window.location.href="/bishe/CLY/index.php/Admin/Delivery/pass/id/"+id;
      }
  </script>
