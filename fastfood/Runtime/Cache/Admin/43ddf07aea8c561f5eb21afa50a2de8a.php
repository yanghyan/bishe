            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
					...
					<form action="/bishe/CLY/index.php/Admin/Comment/index" method="get" class="form-inline">
					...
					<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$com): ?><tr>
						  ...
						  <td>
							<button onclick="doDel(<?php echo ($com["id"]); ?>,this)" class="btn btn-xs btn-danger">删除</button>
						  </td>
	...
	function doDel(id,bt){
		Modal.confirm({msg:'确定要删除当前评论吗？'}).on(function(e){
				if(e){
					...
					$.ajax({
						type:"GET",
						url: '/bishe/CLY/index.php/Admin/Comment/del',
						data:"id="+id,
						dataType:"json",
