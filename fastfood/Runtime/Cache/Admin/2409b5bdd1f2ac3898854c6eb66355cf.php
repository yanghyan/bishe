            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
					...
					<form id="addslide" action="/bishe/CLY/index.php/Admin/Slide/update" method="post" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo ($slide["id"]); ?>"/>
						<div class="form-group">
							<label for="recipient-name" class="control-label">图片描述：</label>
							<input type="text" name="desc" value="<?php echo ($slide["desc"]); ?>" class="form-control" id="recipient-name">
						</div>
						<div class="form-group">
							<label for="recipient-name" class="control-label">选择要替换的图片：</label>
							
								<img src="/bishe/CLY/Public/Admin/Uploads/s_<?php echo ($slide["pic"]); ?>"/>
								<br/><br/>
								<div id="preview">
								<img id="imghead" border="0" src="/bishe/CLY/Public/Admin/images/img/photo_icon.png" width="90" height="90" onclick="$('#previewImg').click();"/>
							 </div>         
						...
						<div class="form-group">
							...
							<input type="text" name="link" value="<?php echo ($slide["link"]); ?>" style="width:500px;"/>
						</div>
						<!-- <div class="form-group">
