          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="/bishe/CLY/index.php/Admin/Users/xgpass" method="post" onsubmit="return doSubmit()">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <fieldset disabled>
                          <input type="input" class="form-control" name="username" placeholder="UserName" id="disabledTextInput" value="<?php echo ($user["username"]); ?>">
                        </fieldset>
                      </div>
                    </div>
                     <div class="form-group">
