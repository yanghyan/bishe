          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
				<form class="form-inline" action="/bishe/CLY/index.php/Admin/Collect/index" method="get">
				  <div class="form-group">
					<div class="input-group">
					  <input type="text" name="username" class="form-control" id="exampleInputAmount" placeholder="用户名"/>
					</div>
					&nbsp;&nbsp;
					<div class="input-group">
					  <input type="text" name="shopname" class="form-control" id="exampleInputAmount" placeholder="店铺名"/>
					</div>
				  </div>
                  ...
                  <table id="tid"  width="300px" class="table table-bordered table-hover">
					...
					<thead>
					<tbody>
					   <?php if(is_array($collectlist)): foreach($collectlist as $key=>$collect): ?><tr class="collect<?php echo ($collect["id"]); ?>">
							  <td><?php echo ($collect["id"]); ?></td>
							  <td><?php echo ($collect["username"]); ?></td>
							  <td><?php echo ($collect["shopname"]); ?></td>
