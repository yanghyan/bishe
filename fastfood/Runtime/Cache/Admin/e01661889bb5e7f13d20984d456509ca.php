            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-plus"></i> 添加配送员信息</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="/bishe/CLY/index.php/Admin/Delivery/insert" method="post" onsubmit="return doSubmit()">
                  <div class="box-body"> 
