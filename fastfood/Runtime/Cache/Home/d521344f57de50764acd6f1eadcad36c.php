			...
			<div class="uc-main fr">
				<div class="w-list" id="J-orders-wrap">
					<ul class="w-status-tab clearfix" mon="area=filterStatus">
						<li class="current">
							<a href="javascript:;" class="first">个人资料修改</a>
						</li>
						
						<form class="layui-form" action="/bishe/CLY/index.php/Home/User/updatePerson" method="post">
						  <input type="hidden" value="<?php echo ($list["id"]); ?>" name="id">
						  <div class="layui-form-item">
							<label class="layui-form-label">昵称</label>
							<div class="layui-input-inline">
							  <input type="text" name="name" lay-verify="title" autocomplete="off" placeholder="请输入昵称" class="layui-input" value="<?php echo ($list["name"]); ?>">
							</div>
						  </div>
						  ...
						  <div class="layui-form-item">
							...
							<div class="layui-input-inline">
							  ...
							  <input type="radio" name="sex" title="男" value="1" <?php if(($list["sex"]) == "1"): ?>checked<?php endif; ?> />
							  <input type="radio" name="sex" title="女" value="0" <?php if(($list["sex"]) == "0"): ?>checked<?php endif; ?> />
						  ...
						  <div class="layui-form-item">
							<div class="layui-inline">
							  ...
							  <div class="layui-input-inline">
								<input type="text" name="email" lay-verify="email" autocomplete="off" class="layui-input" value="<?php echo ($list["email"]); ?>">
							  </div>
							</div>
						  </div>
						  ...
						  <div class="layui-form-item">
							<div class="layui-input-block">
							  <button class="layui-btn" style="background-color:#FF6699;" lay-submit="" lay-filter="demo1">确认修改</button>
