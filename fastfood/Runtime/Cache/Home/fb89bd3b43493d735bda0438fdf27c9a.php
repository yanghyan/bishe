        ...
        <table border="0" class="acc_tab" style="width:870px;" cellspacing="0" cellpadding="0">
              ...
              <tbody>
                <?php if(is_array($list)): foreach($list as $key=>$me): ?><tr >
                    ...
                    <td><?php echo ($me["dname"]); ?></td>
                    <td><?php echo ($me["shop_content"]); ?></td>                   
                    <td><?php echo ($me["deli_content"]); ?></td>
                    <td><?php echo ($me["score"]); ?></td>                    
                    <td><?php echo (date("Y-m-d",$me["addtime"])); ?></td>
                    <td id="button<?php echo ($me["id"]); ?>">    
                      <button onclick="" class="btn btn-xs btn-danger" title="不显示">不显示</button>
                    </td>
