			...
			<div class="uc-main fr">
				<div class="w-list" id="J-orders-wrap">
					<ul class="w-status-tab clearfix" mon="area=filterStatus">
						<li class="current">
							<a href="javascript:;" class="first">用户头像修改</a>
						</li>
						
						<table border="0" style="width:670px; line-height:22px;" cellspacing="0" cellpadding="0">
						  <tr style="float:left;">
							<td width="100">
								原头像<img src="/bishe/CLY/Public/Uploads/s_<?php echo ($list["user_pic"]); ?>" width="90" height="90">
							</td>
						  </tr>
						</table>
						<hr>
						<form action="/bishe/CLY/index.php/Home/User/hSet" method="post" enctype="multipart/form-data">
							<input type="hidden" name="id" value="<?php echo ($list["id"]); ?>"/>						
							<table class="layui-table" lay-even="" lay-skin="row">
								<tr>
									<span style="font-size:18px;">新头像</span>&nbsp;&nbsp;
									<input type="file" name="user_pic">
								</tr> 
							</table>
							<div class="layui-form-item">
								<div class="layui-input-inline">
								  <button class="layui-btn" style="background-color:#FF6699;" lay-submit="" lay-filter="demo1">保存</button>
