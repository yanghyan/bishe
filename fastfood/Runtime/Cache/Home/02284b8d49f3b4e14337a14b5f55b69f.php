			...
			<div class="uc-main fr">
				<div class="w-list" id="J-orders-wrap">
					<ul class="w-status-tab clearfix" mon="area=filterStatus">
						<li class="current">
							<a href="javascript:;" class="first">我的订单</a>
						</li>
						<br><br>
							<table class="layui-table" lay-even="" lay-skin="row">
							  ...
							  <?php if(is_array($list)): foreach($list as $key=>$ind): ?><tr>
									  ...
									  <td><img src="/bishe/CLY/Public/Uploads/s_<?php echo ($ind["menu_pic"]); ?>"></td>
									  <td>￥<?php echo ($ind["price"]); ?></td>
									  ...
									  <td>
										<a onclick="doDel(<?php echo ($ind["id"]); ?>,this);" class="link" id="">删除订单</a><br><br>
										<a href="/bishe/CLY/index.php/Home/User/orderDetail/id/<?php echo ($ind["id"]); ?>" class="link" id="">订单详情</a>
									  </td>
		...
		layui.use(['layer', 'form'], function(){
		  ...
		  layer.confirm('确定删除此订单吗？', {
			  ...
			  //执行Ajax发送并执行删除操作
				$.ajax({
					type:"GET",
					url: '/bishe/CLY/index.php/Home/User/delOrder',
					data:"id="+id,
					dataType:"json",
