			...
			<div class="uc-main fr">
				<div class="w-list" id="J-orders-wrap">
					<ul class="w-status-tab clearfix" mon="area=filterStatus">
						<li class="current">
							<a href="javascript:;" class="first">添加收货地址</a>
						</li>
						
						<form class="layui-form" action="/0308/CLY/index.php/Home/User/insertAddr" method="post">
						  <input type="hidden" value="<?php echo ($list["uid"]); ?>" name="uid">
						  ...
						  <div class="layui-form-item">
						   ...
						   <div class="layui-form-item">
							<div class="layui-inline">
							  ...
							  <!--<div class="layui-input-inline">
								<input type="tel" name="phone" autocomplete="off" class="layui-input" value="<?php echo ($list["phone"]); ?>">
							  </div>-->
						  ...
						  <div class="layui-form-item">
							<div class="layui-inline">
							  ...
							  <div class="layui-input-inline">
								<input type="tel" name="detail_add" autocomplete="off" class="layui-input" placeholder="详细地址">
							  </div>
							</div>
						  </div>
						  <div class="layui-form-item">
							<div class="layui-inline">
							  ...
							  <div class="layui-input-inline">
								<input type="tel" name="phone" lay-verify="phone" autocomplete="off" class="layui-input" placeholder="手机号">
							  </div>
							</div>
						  </div>
						  ...
						  <div class="layui-form-item">
							<div class="layui-input-block">
							  <button class="layui-btn" style="background-color:#FF6699;" lay-submit="" lay-filter="demo1">确认添加</button>
