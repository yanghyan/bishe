				...
				<div class="w-list" id="J-orders-wrap">
					<ul class="w-status-tab clearfix" mon="area=filterStatus">
						...
						<table class="layui-table" lay-even="" lay-skin="row">
						  ...
						  <tbody>
						  <?php if(is_array($shoplist)): foreach($shoplist as $key=>$shop): ?><tr>
							  <td><?php echo ($shop["shopname"]); ?></td>
							  <!--<td><?php echo ($com["mname"]); ?></td>
							  ...
							  <td>
								<a href="/bishe/CLY/index.php/Home/User/addComment/id/<?php echo ($shop["id"]); ?>" id="" class="link">立即评价</a>
							  </td>
