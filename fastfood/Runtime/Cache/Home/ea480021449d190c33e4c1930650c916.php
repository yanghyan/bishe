			...
			<div class="uc-main fr">
				<div class="w-list" id="J-orders-wrap">
					<ul class="w-status-tab clearfix" mon="area=filterStatus">
						<li class="current">
							<a href="javascript:;" class="first">未评价</a>
						</li>
						
						<form class="layui-form" action="/bishe/CLY/index.php/Home/User/insertComment" method="post">
						  <input type="hidden" name="uid" value="<?php echo ($li["uid"]); ?>"/> 
						  <input type="hidden" name="sid" value="<?php echo ($li["sid"]); ?>"/>
						  <input type="hidden" name="did" value="<?php echo ($li["did"]); ?>"/>
						  <div class="layui-form-item">
							<div class="layui-form-item">
								<label class="layui-form-label">评价店铺</label>
								<div class="layui-input-block">
								  <input type="text" name="shop_content" placeholder="" autocomplete="off" class="layui-input">
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">评价配送员</label>
								<div class="layui-input-block">
								  <input type="text" name="deli_content" placeholder="" autocomplete="off" class="layui-input">
								</div>
							</div>
							<div class="layui-form-inline">
								<label class="layui-form-label">评分</label>
								<div class="layui-input-inline">
								  <input type="text" name="score" placeholder="" autocomplete="off" class="layui-input">评分标准：1~5分
								</div>
							</div>
						  </div>
						  ...
						  <div class="layui-form-item">
							<div class="layui-input-block">
							  <button class="layui-btn" style="background-color:#FF6699;" lay-submit="" lay-filter="demo1" type="submit">确认评价</button>
							</div>
						  </div>
						</form>	
					</ul>
