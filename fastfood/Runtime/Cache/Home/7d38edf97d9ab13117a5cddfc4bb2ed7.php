...
<html>
	...
	<!--<script src="/0308/CLY/Public/Admin/js/jquery-1.10.2.js"></script>-->
</head>
			...
			<div class="uc-main fr">
				<div class="w-list" id="J-orders-wrap">
					<ul class="w-status-tab clearfix" mon="area=filterStatus">
						<li class="current">
							<a href="javascript:;" class="first">已评价</a>
						</li>
						
						<form class="layui-form" action="/0308/CLY/index.php/Home/User/updateComment" method="post">
						  <input type="hidden" name="id" value="<?php echo ($list["id"]); ?>"/>
						  <div class="layui-form-item">
							<div class="layui-form-item">
								<label class="layui-form-label">评价店铺</label>
								<div class="layui-input-block">
								  <input type="text" name="shop_content" placeholder="" autocomplete="off" class="layui-input" value="<?php echo ($list["shop_content"]); ?>">
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">评价配送员</label>
								<div class="layui-input-block">
								  <input type="text" name="deli_content" placeholder="" autocomplete="off" class="layui-input" value="<?php echo ($list["deli_content"]); ?>">
								</div>
							</div>
							<div class="layui-form-inline">
								<label class="layui-form-label">评分</label>
								<div class="layui-input-inline">
								  <input type="text" name="score" placeholder="" autocomplete="off" class="layui-input" value="<?php echo ($list["score"]); ?>">评分标准：1~5分
								</div>
							</div>
						  </div>
