...
<html>
	...
	<!--分页css-->
	<link rel="stylesheet" type="text/css" href="/0308/CLY/Public/css/page.css"/>
				...
				<div class="w-list" id="J-orders-wrap">
					<ul class="w-status-tab clearfix" mon="area=filterStatus">
						...
						<table class="layui-table" lay-even="" lay-skin="row">
						  ...
						  <tbody>
						  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$com): $mod = ($i % 2 );++$i;?><tr>
							  <td><?php echo ($com["shopname"]); ?></td>
							  <td><?php echo ($com["name"]); ?></td>
							  <td><?php echo ($com["shop_content"]); ?></td>
							  <td><?php echo ($com["deli_content"]); ?></td>
							  <td><?php echo ($com["score"]); ?></td>
							  <td><?php echo (date("Y-m-d",$com["addtime"])); ?></td>
							  <td>
								<a href="/0308/CLY/index.php/Home/User/mComment/id/<?php echo ($com["id"]); ?>" id="" class="link">修改</a>
							  </td>
