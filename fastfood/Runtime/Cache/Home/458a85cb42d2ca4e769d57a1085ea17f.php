...
<div class="i_bg bg_color">
	...
	<div class="m_content">
        ...
        <table border="0" class="acc_tab" style="width:870px;" cellspacing="0" cellpadding="0">
              ...
              <tbody>
                <?php if(is_array($list)): foreach($list as $key=>$me): ?><tr align="center">
                    <td><?php echo ($me["username"]); ?></td>
                    <td><?php if(($me["sex"] == 1) ): ?>男<?php elseif(($me["sex"] === '0') ): ?>女<?php endif; ?></td>
                    <td><?php echo ($me["phone"]); ?></td>
                    <td><?php echo ($me["email"]); ?></td>                   
                    <td><?php echo ($me["sum"]); ?></td>
